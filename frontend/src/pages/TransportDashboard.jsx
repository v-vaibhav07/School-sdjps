...
import BookLoader from "../components/BookLoader" // ✅ STEP 1: loader import

function TransportDashboard() {

    const [buses, setBuses] = useState([])
    const [loading, setLoading] = useState(true) // ✅ STEP 2: loading state add
    ...
    useEffect(() => {
        ...
        const fetchBuses = async () => {
            ...
            try {
                ...
                setLoading(true) // ✅ STEP 3: loading start
                ...
                setLoading(false) // ✅ STEP 4: loading end
            }
    ...
    // ✅ STEP 5: loader show karo jab data load ho raha ho
